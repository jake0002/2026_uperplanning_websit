...
POSTS_DATA.forEach((post, index) => {
  ...
  // Replace post-nav-section HTML with clear full-title display and Far-Right 목록보기 button
  const newPostNavHtml = `<!-- BOTTOM NAV WITH PREV/NEXT POST FULL TITLES & FAR-RIGHT LIST VIEW BUTTON -->
  ...
  console.log(`Updated post navigation layout for post-${post.id}`);
});

console.log('ALL POST DETAIL PAGES UPDATED WITH FAR-RIGHT 목록보기 BUTTON & FULL TITLES!');
