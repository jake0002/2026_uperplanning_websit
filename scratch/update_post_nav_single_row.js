...
POSTS_DATA.forEach((post, index) => {
  ...
  // Replace post-nav-section HTML with single horizontal row layout
  const newPostNavHtml = `<!-- BOTTOM NAV WITH PREV/NEXT POST & LIST VIEW BUTTON ON SAME HORIZONTAL ROW -->
  ...
  console.log(`Updated post navigation to single horizontal row for post-${post.id}`);
});

console.log('ALL POST NAVIGATION ROWS UPDATED SUCCESSFULLY!');
