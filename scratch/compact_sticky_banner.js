...
// Replace CSS block for sticky banner with compact styling
const oldCssStart = html.indexOf('/* Right Sticky Course Banner (Exact Attached Image Match) */');
const oldCssEnd = html.indexOf('</style>', oldCssStart);

const newCssBlock = `/* Right Sticky Course Banner (Compact Sleek Sizing) */
    .page-wrapper {
