...
(async () => {
  ...
  if (html.includes(anchor)) {
    ...
    html = html.replace('</head>', `<style>${unifiedCSS}</style></head>`);
  }

  fs.writeFileSync('scratch/temp_unified_ux_academy.html', html, 'utf8');
  ...
  await page.screenshot({ path: 'scratch/ux_academy_unified.png', fullPage: false });
  console.log('Saved screenshot to scratch/ux_academy_unified.png');
