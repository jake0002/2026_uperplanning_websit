...
<body>
  ...
  <div class="page-wrapper">
    <div class="explorer-window">
      ...
      <div class="menubar">
        <span><u>File</u></span> <span><u>Edit</u></span> <span><u>View</u></span> <span><u>Help</u></span>
      </div>

      <div class="toolbar-area">
        <div class="nav-buttons">
          <button class="tool-btn" onclick="location.href='/ux-blog/';">⬅ 목록으로 돌아가기</button>
        </div>
        <div class="address-bar">
          <span class="addr-label">주소(D):</span>
          <div class="addr-input">C:\\SUPERPLANNING\\UX_서비스\\UX_블로그\\${post.title}</div>
        </div>
      </div>
      ...
      <div class="explorer-split">
        ...
        <main class="main-content-pane">
          ...
          <!-- BOTTOM NAV WITH PREV & NEXT POST ON THE EXACT SAME HORIZONTAL ROW -->
      ...
      <div class="statusbar">
        <div>1개 개체 선택됨</div>
        <div>C:\\SUPERPLANNING\\UX_서비스\\UX_블로그\\${post.title}</div>
        <div>내 컴퓨터</div>
      </div>
    </div>
  </div>
...
<!-- RETRO BACK TO TOP ANCHOR BUTTON (EXACT UX-RESEARCH MATCH) -->
  ...
  console.log(`Updated standalone article page with prev/next nav: /ux-blog/post-${post.id}/index.html`);
});

console.log('ALL 19 POST DETAIL PAGES UPDATED WITH PREV/NEXT NAV AND CLEANED FRONTEND LINKS!');
