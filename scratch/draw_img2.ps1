...
$srcPath = "implementation/images/ux_consulting_2.jpg"
$dstPath = "implementation/images/ux_consulting_2.jpg"
$newText = "📷 모바일앱 UX리뉴얼 컨설팅"
$bannerHeight = 44
