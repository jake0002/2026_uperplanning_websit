...
function Crop-ImageBottom($srcPath, $dstPath, $cropBottomPixels) {
    ...
    $bmp.Dispose()
    Write-Host ("Cropped {0}: New size {1}x{2}" -f $dstPath, $newW, $newH)
}

# Crop images
Crop-ImageBottom "scratch/img1.jpg" "implementation/images/ux_consulting_1.jpg" 52
Crop-ImageBottom "scratch/img2.jpg" "implementation/images/ux_consulting_2.jpg" 50
...
Write-Host ("Base64 1 len: {0}, Base64 2 len: {1}" -f $b64_1.Length, $b64_2.Length)

# Save Base64 to text files for Node script to read
