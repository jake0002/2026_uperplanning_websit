...
<head>
  ...
  <style>
    /* ==================================================== */
    /* DESIGN TOKENS & RESET (EXACT UX-RESEARCH SUBPAGE MATCH) */
    /* ==================================================== */
    :root {
      --bg: #ffffff;
      --win-bg: #c0c0c0;
    ...
    * {
    ...
    /* Outer Wrapper for Left Alignment */
    .page-wrapper {
    ...
    /* ==================================================== */
    /* WINDOWS 95 EXPLORER CONTAINER WINDOW (EXACT UX-RESEARCH MATCH) */
    /* ==================================================== */
    .explorer-window {
      width: 100%;
      max-width: 1100px;
    ...
    /* 1. Black Titlebar (#000000 - Main Screen Match) */
    .titlebar {
      background: #000000;
      color: #ffffff;
      padding: 4px 8px;
    ...
    .tool-btn:active { box-shadow: inset 1px 1px 0 #808080; }
    ...
    /* Left Explorer Tree View Sidebar (Exact UX-Research Match) */
    .tree-sidebar {
      width: 260px;
      min-width: 240px;
      background: #ffffff;
    ...
    /* Tree Navigation List (ul.tree-list.toc) */
    ul.tree-list {
    ...
    .icon-action-btn.bookmarked { color: #000000; font-weight: bold; }
    ...
    .modal-post-content p { margin-bottom: 14px; }
    .modal-post-content h3 { font-size: 16px; font-weight: 800; margin: 20px 0 10px; color: #000000; }
...
<body>
  ...
  <!-- 3. HOME BUTTON AT FAR LEFT (EXACT COPY FROM UX-RESEARCH) -->
  ...
  <!-- 4. GNB HEADER (EXACT COPY FROM UX-RESEARCH) -->
  <div id="gnb">
    <ul class="gnb-menu">
      <li class="gnb-item">
  ...
  <div class="page-wrapper">
    ...
    <div class="explorer-window">
      ...
      <div class="explorer-split">
        ...
        <!-- Left Explorer Tree Sidebar (Exact UX-Research Match) -->
        <aside class="tree-sidebar" aria-label="탐색기 목차 트리">
          ...
          <ul class="tree-list toc" id="categoryNav">
            <li class="tree-item"><a href="javascript:void(0)" class="tree-link active" data-category="all"><span class="doc-icon">📄</span> <span>▣ 전체글 보기</span> <span class="badge-count" id="countAll">19</span></a></li>
            <li class="tree-item"><a href="javascript:void(0)" class="tree-link" data-category="bookmark"><span class="doc-icon">📄</span> <span>★ 즐겨찾기 보기</span> <span class="badge-count" id="countFav">0</span></a></li>
            <li class="tree-item"><a href="javascript:void(0)" class="tree-link" data-category="UX리서치"><span class="doc-icon">📄</span> <span>1. UX리서치</span> <span class="badge-count">3</span></a></li>
            <li class="tree-item"><a href="javascript:void(0)" class="tree-link" data-category="UX라이팅"><span class="doc-icon">📄</span> <span>2. UX라이팅</span> <span class="badge-count">4</span></a></li>
            <li class="tree-item"><a href="javascript:void(0)" class="tree-link" data-category="UX기획/디자인"><span class="doc-icon">📄</span> <span>3. UX기획/디자인</span> <span class="badge-count">3</span></a></li>
            <li class="tree-item"><a href="javascript:void(0)" class="tree-link" data-category="AI트랜드"><span class="doc-icon">📄</span> <span>4. AI트랜드</span> <span class="badge-count">3</span></a></li>
            <li class="tree-item"><a href="javascript:void(0)" class="tree-link" data-category="피그마"><span class="doc-icon">📄</span> <span>5. 피그마</span> <span class="badge-count">3</span></a></li>
            <li class="tree-item"><a href="javascript:void(0)" class="tree-link" data-category="바이브코딩"><span class="doc-icon">📄</span> <span>6. 바이브코딩</span> <span class="badge-count">3</span></a></li>
          </ul>
        </aside>
  ...
  <div class="w95-modal-backdrop" id="postModal">
    <div class="w95-modal-window">
      <div class="modal-titlebar">
        ...
        <button class="win-btn" onclick="closeModal();" style="cursor:pointer;">✕</button>
      </div>
  ...
  <script>
    ...
    function renderCards() {
      ...
      // Update Counts
      if (countAllEl) countAllEl.textContent = POSTS_DATA.length;
      if (countFavEl) countFavEl.textContent = bookmarks.length;
      if (statusCountEl) statusCountEl.textContent = \`\${filtered.length}개 개체\`;
...
files.forEach(f => {
  ...
  fs.writeFileSync(fullPath, blogPageHtml, 'utf8');
  console.log('Successfully synced UX Research skin to:', f);
});
