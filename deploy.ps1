...
ssh -i "shkey.pem" -o StrictHostKeyChecking=no admin@13.125.12.112 "rm -rf /tmp/deploy_stage && mkdir -p /tmp/deploy_stage/images /tmp/deploy_stage/services /tmp/deploy_stage/company /tmp/deploy_stage/ux_design /tmp/deploy_stage/ux_research /tmp/deploy_stage/ux_design_cleanroom"
...
ssh -i "shkey.pem" -o StrictHostKeyChecking=no admin@13.125.12.112 "sudo cp -f /tmp/deploy_stage/index.html /var/www/html/index.html && sudo cp -f /tmp/deploy_stage/ux_research.html /var/www/html/ux_research.html && sudo cp -f /tmp/deploy_stage/ux-research.html /var/www/html/ux-research.html && sudo cp -f /tmp/deploy_stage/ux_design.html /var/www/html/ux_design.html && sudo cp -f /tmp/deploy_stage/ux-design.html /var/www/html/ux-design.html && sudo cp -f /tmp/deploy_stage/company.html /var/www/html/company.html && sudo mkdir -p /var/www/html/company && sudo cp -f /tmp/deploy_stage/company/index.html /var/www/html/company/index.html && sudo mkdir -p /var/www/html/ux_design && sudo cp -f /tmp/deploy_stage/ux_design/index.html /var/www/html/ux_design/index.html && sudo mkdir -p /var/www/html/ux_design_cleanroom && sudo cp -f /tmp/deploy_stage/ux_design_cleanroom/index.html /var/www/html/ux_design_cleanroom/index.html && sudo cp -f /tmp/deploy_stage/ux_design_cleanroom.html /var/www/html/ux_design_cleanroom.html && sudo cp -f /tmp/deploy_stage/ux_design_cleanroom.html /var/www/html/ux-design-cleanroom.html && sudo cp -f /tmp/deploy_stage/llms.txt /var/www/html/llms.txt && sudo mkdir -p /var/www/html/services && sudo cp -f /tmp/deploy_stage/services/ux-research.md /var/www/html/services/ux-research.md && sudo cp -f /tmp/deploy_stage/services/ux-planning-design.md /var/www/html/services/ux-planning-design.md && sudo mkdir -p /var/www/html/ux_research/images && sudo cp -f /tmp/deploy_stage/ux_research/index.html /var/www/html/ux_research/index.html && sudo cp -rf /tmp/deploy_stage/images/* /var/www/html/images/ && sudo cp -rf /tmp/deploy_stage/images/* /var/www/html/ux_research/images/ && sudo chmod -R 755 /var/www/html && sudo chown -R admin:www-data /var/www/html"
